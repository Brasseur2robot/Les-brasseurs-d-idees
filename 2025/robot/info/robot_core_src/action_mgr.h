...
typedef enum
{
  ...
  ACTION_MGR_ID_SORT_EJECT = 5u,        /* Move arm to back and sort the boxes while ejecting them */
  ACTION_MGR_ID_SORT_EJECT_INVERT = 6u, /* Move arm to back and sort the boxes while ejecting them */
