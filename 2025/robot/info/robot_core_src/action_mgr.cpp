...
#define ACTION_MGR_GRAB_BOXES_NBSTEPS  16
...
#define ACTION_MGR_SORT_ALL_NBSTEPS  9
static actionStep_t actionStepSortAll_st[ACTION_MGR_SORT_ALL_NBSTEPS] = {
  ...
  //{ACTION_ACTUATOR_TYPE_SERVO, SERVO_BOARD_STOPPER_ID, SERVO_BOARD_STOPPER_RETRACTED, NODELAY, WAIT},
  {ACTION_ACTUATOR_TYPE_DYNAMIXEL, ACTUATOR_DXL_GRABBER_ID, ACTUATOR_DXL_GRABBER_MINI_OPEN, NODELAY, WAIT},
