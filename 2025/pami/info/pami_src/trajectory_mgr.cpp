  ...
  if ( (trajectoryIndex_u8 > trajectoryIndexLast_i8) && (trajectoryFinished_b == false) )
  {
    ...
    switch (trajectoryIndex_u8)
    {
      ...
      case 1:
        ...
        if ( MatchMgrGetColor() == MATCH_COLOR_YELLOW)
        {
          OdometrySetXMeter(0.6 - PAMI_BACKWIDTH);
          OdometrySetThetaDeg(180.0);
          PositionMgrSetOrientationControl(true);
          PositionMgrGotoDistanceMeter(0.6 - MATCH_START_POSITION_X_YELLOW - PAMI_BACKWIDTH, true);
        }
        else
        {
          OdometrySetXMeter(3.0 - 0.6 + PAMI_BACKWIDTH);
          OdometrySetThetaDeg(0.0);
          PositionMgrSetOrientationControl(true);
          PositionMgrGotoDistanceMeter(3.0 - MATCH_START_POSITION_X_BLUE - PAMI_BACKWIDTH, true);
        }
        /* Move forward X cm */
      ...
      case 4:
        ...
        OdometrySetYMeter(2.0 - PAMI_BACKWIDTH);
        OdometrySetThetaDeg(-90.0);
        /* Move forward */
        PositionMgrSetOrientationControl(true);
        PositionMgrGotoDistanceMeter(2.0 - MATCH_START_POSITION_Y - PAMI_BACKWIDTH, true);
        /* Finished */
        ...
        {
          OdometrySetXMeter(MATCH_START_POSITION_X_BLUE);
        }
